...
export default function RecipeTestimonial() {
  return (
    <section className="relative overflow-hidden px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
      ...
      <div className="absolute inset-0 bg-[#FFF0CD]">
        {/* Wavy border image */}
        <Image
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mb-8 text-center sm:mb-12 lg:mb-16">
          <h2 className="px-4 text-2xl font-bold text-black sm:text-3xl lg:text-4xl">
          ...
          <div className="relative mx-4 w-full max-w-4xl rounded-lg bg-white p-4 sm:p-6 lg:p-8">
            ...
            <div className="pt-6 sm:pt-8">
              <div className="mb-4 flex">
                {fillArrayWithNumber(5).map((_, i) => (
                  <Star key={i} className="h-7 w-7 fill-[#FFBA0A] text-[#FFBA0A]" />
                ))}
              </div>
              <blockquote
