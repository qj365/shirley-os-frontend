...
function ShopHeroSection() {
  return (
    <div 
      ...
      style={{
        backgroundImage: "url('/image/shopHeroImage.png')",
      }}
    >
      ...
      <div className="top-[35%] w-full px-4 relative z-10">
        <div className="flex flex-col items-center gap-4 sm:gap-6 md:gap-8 text-center">
          <h1 className="text-xl sm:text-xl md:text-4xl font-bold text-white drop-shadow-lg">
            Shop Our Products
          </h1>
          
          <p className="text-base sm:text-base md:text-lg lg:text-xl text-white font-medium max-w-[90%] sm:max-w-[80%] md:max-w-[70%] drop-shadow-md">
