  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 pt-32 sm:px-6 sm:pt-36 md:pt-40 lg:pt-35">
        <div className="3xl:gap-6 4xl:gap-4 max-w-screen-4xl 3xl:max-w-[60%] 4xl:max-w-[45%] mx-auto grid min-h-[calc(100vh-8rem)] items-start justify-center gap-6 md:gap-8 lg:grid-cols-2 lg:gap-12 xl:gap-10 2xl:min-h-0 2xl:gap-8 2xl:py-16">
          {/* Left Content */}
          <div className="relative z-10 order-2 flex flex-col justify-center gap-4 px-4 sm:px-0 md:gap-6 lg:order-1 lg:gap-8">
            {/* Brand Badge */}
            <div className="mb-2 flex flex-col items-center gap-2 sm:flex-row lg:items-start">
              ...
              <div className="flex items-center gap-1">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="h-4 w-4 fill-[#F3C03F] text-[#F3C03F]" />
                ))}
                <span className="ml-1 text-sm text-[#6B7280]">(2,500+ reviews)</span>
              </div>
            </div>
            ...
            <p className="3xl:text-2xl 4xl:text-3xl 4xl:max-w-3xl max-w-xl text-base leading-relaxed text-[#6B7280] sm:text-lg md:text-xl">
              🍚 Authentic West African flavours ready in minutes. No prep, no mess, just pure
              deliciousness.
            </p>
            ...
            <div className="3xl:max-w-5xl 4xl:max-w-[850px] relative mx-auto aspect-square w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl">
              ...
              <div className="relative h-full w-full">
                ...
                <div className="4xl:px-4 4xl:py-3 absolute bottom-7 left-2 z-30 rounded-full bg-gradient-to-r from-[#F3C03F] to-[#FFBA0A] px-2 py-1 text-white shadow-lg md:bottom-2 md:px-3 md:py-2">
                  <span className="4xl:text-sm text-xs font-semibold">⚡ 35 Min Ready</span>
                </div>
                  ...
                  {dishImages.map((_, index) => (
                    <div
                      ...
                      className={`h-1.5 w-1.5 rounded-full transition-all duration-300 ${
                        index === currentDishIndex ? 'scale-125 bg-[#F3C03F]' : 'bg-[#F3C03F]/30'
                      }`}
                    />
                  ))}
                </div>
      ...
      <div className="absolute top-1/2 right-4 z-40 hidden -translate-y-1/2 transform lg:block">
        ...
        {/* Social Proof Badge */}
        <div className="absolute -bottom-12 -left-6 rounded-xl bg-white/95 p-3 shadow-lg backdrop-blur-sm 2xl:-bottom-8">
          <div className="text-center">
            <div className="mb-1 flex items-center justify-center space-x-0.5">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="h-2.5 w-2.5 fill-[#F3C03F] text-[#F3C03F]" />
              ))}
            </div>
