  ...
  const renderSection = useMemo(() => {
    const steps = [
      ...
      },
      {
        key: 2,
        name: 'Payment',
        icon: <Image width={28} height={28} alt="step icon" src="/svg/credit-card.svg" />,
      },
      {
        key: 3,
        name: 'Confirmation',
        icon: <Image width={28} height={28} alt="step icon" src="/svg/checkmark-done.svg" />,
      },
    ];
        ...
        {steps.map((item, index) => {
          return (
            ...
            >
              ...
              {index < steps.length - 1 && <div className="h-0.5 !min-h-0.5 flex-1 bg-[#aeaeae]" />}
            </div>
          );
        })}
      </div>
          ...
          {step === 1 && (
            <div className="grid grid-cols-1 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>I would like to book for</FormLabel>
                    <FormControl>
                      <input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <input className="sh-text-input" placeholder="Enter Full name" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <input className="sh-text-input" placeholder="Enter Email" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <input className="sh-text-input" placeholder="Enter Phone no" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <input className="sh-text-input" placeholder="Enter Booking for" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Any dietary requirements or allergies?</FormLabel>
                    <FormControl>
                      <input
                        className="sh-text-input"
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <input className="sh-text-input" placeholder="Enter Card number" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <input className="sh-text-input" placeholder="MM/YY" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <input className="sh-text-input" placeholder="Enter cvv" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <input className="sh-text-input" placeholder="Enter region" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <div>
                ...
                <p className="text-justify text-base font-medium">
                  Registration opens 15 minutes before the class starts. Dietary requirements can be
                  catered for but only if known in advance. If you have a Virgin experience days
                  voucher, please contact us and we can place your booking. In our cooking class, we
                  use induction hobs. If you have a pacemaker fitted, please get in touch with us.
                  Please familiarize yourself with our cancellation policy prior to booking. 
                </p>
              </div>
            </div>
          )}
          ...
          {step === 3 && (
            <div className="flex flex-col items-center gap-10 md:gap-15">
              ...
              <p className="text-center text-sm md:text-xl">
                Dear Ibrahim Shorey,
                <br />
                Thank you for booking your cooking class with us! 🎊 <br /> We’re excited to have
                you join us for a fun and delicious experience.
              </p>
              <div className="mx-auto flex items-start gap-3">
                ...
                <Label htmlFor="cookingClassBookingGetNews">
                  I am happy for Shirley’s to send me exclusive information and deals, from time to
                  time.
                </Label>
              </div>
            </div>
