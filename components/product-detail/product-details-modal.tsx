...
interface ProductDetailsModalProps {
  data: {
    ...
    ingredients: string
    shelf_life: string
    nutritional_info: string | Record<string, string | number | boolean>
    additional_info: string | Record<string, string | number | boolean>
...
export default function ProductDetailsModal({ data, isOpen, onClose }: ProductDetailsModalProps) {
  ...
  const formatNutritionalInfo = (info: unknown) => {
    if (!info) return null
  ...
  const formatAdditionalInfo = (info: unknown) => {
    if (!info) return null
