    ...
    <>
      ...
      <section className="container py-7.5">
        ...
        <div className="mb-12.5 rounded-[10px] bg-[#FFEDC3] p-[20px]">
          <h2 className="mb-2.5 text-lg font-bold md:text-3xl">What to Expect</h2>
          <p className="text-sm leading-5 md:text-xl md:leading-14">
            Welcome drink on arrival Introduction to West African ingredients and spices
            Demonstration by our Chef Hands-on cooking of perfect Jollof rice Learn about regional
            variations and techniques Enjoy your creation with fellow participants Take home a jar
            of Shirley&apos;s Jollof Paste
          </p>
        </div>
        <div>
          ...
          <p className="text-sm leading-5 md:text-xl md:leading-14">
            ...
            catered for if known in advance. Please familiarise yourself with our cancellation
            policy prior to booking. All equipment and ingredients provided.
          </p>
        </div>
      </section>
      ...
      <section className="container flex flex-col gap-[20px] py-[50px] md:gap-[35px] md:py-[150px]">
        <h2 className="text-center text-lg font-bold md:text-3xl">Private Bookings</h2>
        <p className="text-center text-sm leading-5 md:text-xl md:leading-14">
          Looking for a bespoke experience? We offer private classes for special occasions and
          corporate events.
        </p>
