...
import Section1 from "@/components/product-detail/section1"
import getProduct, { Product, getProductById } from "@/services/get-product"
...
export default function ProductDetail() {
  ...
  return (
    <>
      {/* Pass the fetched product as a prop to Section1 */}
