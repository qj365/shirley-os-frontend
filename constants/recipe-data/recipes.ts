...
export const recipes: Recipe[] = [
  {
    ...
    heroImage: '/image/recipe_1_hero_updated.jpg',
    metaInfo: {
      serves: '4-6 people',
      cookTime: '25 minutes',
    ...
    instructions: [
      ...
      },
      {
        ...
        description:
          "Add 1 teaspoon of Shirley's Jollof Paste or the entire jar if you prefer a richer taste",
      },
      {
        title: 'Add water',
        description:
          'Add the appropriate amount of water to the amount of rice used in step 1',
      },
      {
        title: 'Season',
        description:
          'Add salt and pepper as desired or your secret ingredient, unique to your household',
      },
      {
      ...
      },
      {
        ...
        description:
          'If using a rice cooker, simply go to cook mode and at the end of the cycle, give the rice a stir and let it steam with foil on once cooked for 10 minutes. If using the stove, please cook on a low heat and occasionally stir rice every 10 minutes until cooked. Once rice has cooked - usually 20-25mins, turn off stove and let the rice steam for 10mins with the foil and lid on.',
      },
    ],
  },
  {
    ...
    heroImage: '/image/recipe_2_hero_updated.jpg',
    customHeroImageClass: 'object-bottom',
    metaInfo: {
      serves: '2-4 people',
    ...
    instructions: [
      {
        ...
        description:
          'Peel and slice your medium onion into your preferred thickness. Whether you like them chunky or thinly sliced, both work wonderfully with this recipe.',
      },
      {
        title: 'Heat your pan',
        description:
          "Heat 1 tablespoon of your preferred oil in a wok or frying pan over high heat. Let the oil get nice and hot - you'll know it's ready when it shimmers slightly.",
      },
      {
        title: 'Sauté the onions',
        description:
          'Add your chopped onions to the hot pan and sauté for 2-3 minutes, stirring occasionally. Watch as they begin to soften and become fragrant.',
      },
      {
        title: 'Add the magic',
        description:
          "Stir in 2 heaped tablespoons of Shirley's Jollof Paste. Mix well to coat all the onions in that rich, authentic West African flavour. Cook for another 1-2 minutes until the paste is heated through and aromatic.",
      },
      {
        title: 'Create your masterpiece',
        description:
          "This is where the fun begins! Use these beautifully sautéed onions as the foundation for whatever sauce your heart desires. Whether you're building a hearty vegetable stew, a succulent chicken casserole, a tender lamb dish, or a robust beef creation - these onions are your flavour-packed starting point.",
      },
    ],
    chefTips: [
    ...
    perfectPairings:
      'Use as a base for curries, stews, pasta sauces, or even as a flavourful side dish on their own.',
  },
  {
    id: '3',
    title: 'Hearty Mushroom Spinach Stew',
    slug: 'hearty-mushroom-spinach-stew',
    heroImage: '/image/recipe_3_hero_updated.jpg',
    metaInfo: {
      serves: '3-4 people',
